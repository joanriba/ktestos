...
mysql_query("INSERT INTO nens(idpare,nom,cognoms,birthdate,adreca,poblacio,cp,escolaultim,cursacabat,antitetanica,alergia,nomalergia,croniques,nomcroniques,intervingut,nomintervingut,discapacitat,nomdiscapacitat,caracter,patologies,patologies2,autoritzaciomedica) VALUES('$_POST[idpare]','$_POST[nom]','$_POST[cognoms]','$_POST[birthdate]','$_POST[adreca]','$_POST[poblacio]','$_POST[cp]','$_POST[escolaultim]','$_POST[cursacabat]','$_POST[antitetanica]','$_POST[alergia]','$_POST[nomalergia]','$_POST[croniques]','$_POST[nomcroniques]','$_POST[intervingut]','$_POST[nomintervingut]','$_POST[discapacitat]','$_POST[nomdiscapacitat]','$_POST[caracter]','$_POST[patologies]','$_POST[patologies2]','$_POST[autoritzaciomedica]')",$cxn);
...
$antitetanica=$row[antitetanica];$alergia=$row[alergia]; $nomalergia=$row[nomalergia]; $croniques=$row[croniques]; $nomcroniques=$row[nomcroniques]; $intervingut=$row[intervingut]; $nomintervingut=$row[nomintervingut]; $discapacitat=$row[discapacitat]; $nomdiscapacitat=$row[nomdiscapacitat]; $caracter=$row[caracter]; $patologies=$row[patologies]; $patologies2=$row[patologies2]; $autoritzaciomedica=$row[autoritzaciomedica];}
?>    
