...
//	alert(able); //joe//
    if (able) {
      ...
      self.button.className = 'inputButtonActive btlila';
      self.enabled = true;
    }
    else {
      self.button.onclick = null;
      self.button.disabled = true;
      self.button.className = 'inputButtonDisabled btlilai';
      self.enabled = false;
    }
  };
  ...
  this.submitData = function() {
    ...
    self.ajax.doPost('/ouf.php?action=login&idioma=<?=$idioma?>', postData, self.handleLoginResp);
    ...
    var self = Login;
    self.setPrompt('proc', 'Processant');
